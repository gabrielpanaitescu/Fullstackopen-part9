import { Gender, ParsedPatientData } from "../types";
...
export const parseNewPatientData = (object: unknown): ParsedPatientData => {
  ...
  throw new Error("Incorrect data: some fields are missingt");
};
